...
class ChildProfile extends HiveObject {
  ...
  /// Create from JSON for cloud sync
  factory ChildProfile.fromJson(Map<String, dynamic> json) {
    return ChildProfile(
      ...
      conceptProgress: (json['conceptProgress'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as int)) ?? {},
      stars: json['stars'] as int? ?? 0,
      unlockedItems: (json['unlockedItems'] as List<dynamic>?)?.cast<String>() ?? [],
      currentChapter: json['currentChapter'] as String? ?? 'chapter_1',
      currentStage: json['currentStage'] as String? ?? 'chapter_1_stage_1',
      ...
      recentAttempts: (json['recentAttempts'] as List<dynamic>?)?.cast<bool>() ?? [],
      wordsLearned: (json['wordsLearned'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as int)) ?? {},
      timePlayedPerDay: (json['timePlayedPerDay'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as int)) ?? {},
      conversationHistoryIds: (json['conversationHistoryIds'] as List<dynamic>?)?.cast<String>() ?? [],
      spacedRepetitionCardIds: (json['spacedRepetitionCardIds'] as List<dynamic>?)?.cast<String>() ?? [],
      unlockedTreasures: (json['unlockedTreasures'] as List<dynamic>?)?.cast<String>() ?? [],
      currentStreak: json['currentStreak'] as int? ?? 0,
      longestStreak: json['longestStreak'] as int? ?? 0,
      lastSyncedAt: json['lastSyncedAt'] != null ? DateTime.parse(json['lastSyncedAt'] as String) : null,
      preferredLanguage: json['preferredLanguage'] as String? ?? 'bilingual',
      recentGameResults: (json['recentGameResults'] as List<dynamic>?)?.cast<bool>() ?? [],
