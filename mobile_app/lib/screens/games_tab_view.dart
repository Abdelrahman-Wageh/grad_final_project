...
/// Games tab - displays ALL 8 games (5 letter games + 3 procedural games)
...
class GamesTabView extends StatelessWidget {
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'اختر لعبة وابدأ المغامرة! (8 ألعاب)',
            ...
            Expanded(
              child: Padding(
                ...
                child: GridView.count(
                  ...
                  children: [
                    // LETTER LEARNING GAMES (5 games from GameRegistry)
                    _buildGameCard(
                      context: context,
                      title: 'البالونات',
                      subtitle: 'اضغط على البالونات بالحرف الصحيح',
                      emoji: '🎈',
                      gradient: SmartinoColors.sunsetGlow,
                      onTap: () => _startLetterGame(context, GameType.letterBalloons),
                    ),
                    _buildGameCard(
                      context: context,
                      title: 'الزحمة السريعة',
                      subtitle: 'اختار كل الحروف الصحيحة',
                      emoji: '👥',
                      gradient: SmartinoColors.oceanBreeze,
                      onTap: () => _startLetterGame(context, GameType.fastCrowd),
                    ),
                    _buildGameCard(
                      context: context,
                      title: 'الحرف الناقص',
                      subtitle: 'أكمل الكلمة بالحرف المناسب',
                      emoji: '🔤',
                      gradient: SmartinoColors.forestMist,
                      onTap: () => _startLetterGame(context, GameType.missingLetter),
                    ),
                    _buildGameCard(
                      context: context,
                      title: 'الحروف المخلوطة',
                      subtitle: 'رتب الحروف لتكوين الكلمة',
                      emoji: '🔀',
                      gradient: SmartinoColors.lavenderDream,
                      onTap: () => _startLetterGame(context, GameType.mixedLetters),
                    ),
                    _buildGameCard(
                      context: context,
                      title: 'القراءة',
                      subtitle: 'اقرأ الجملة وأجب على السؤال',
                      emoji: '📖',
                      gradient: SmartinoColors.lavenderDream,
                      onTap: () => _startLetterGame(context, GameType.reading),
                    ),
                    
                    // PROCEDURAL GAMES (3 games)
                    _buildGameCard(
                      context: context,
                      title: 'قائد الأكواد',
  ...
  void _startLetterGame(BuildContext context, GameType gameType) {
    ...
    // Create game widget using registry
    final gameWidget = GameRegistry.createGameByType(
      gameType,
      'practice_${gameType.name}', // Stage ID for practice mode
