    ...
    for (var chapter in CurriculumData.allChapters) {
      for (var stage in chapter.stages) {
        if (stage.id == levelId) {
          ...
          return {
            'id': stage.id,
            'type': 'vocabulary', // Default type - TODO: Add to Stage model
            'words': [], // TODO: Add actual word data
            'sentences': [], // TODO: Add actual sentence data
            'combinations': [], // TODO: Add actual combination data
          };
        }
      }
    }
