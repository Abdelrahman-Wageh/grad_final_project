...
async def root():
    ...
    return {
        ...
        "documentation": {
            "swagger_ui": f"{base_url}/docs" if settings.DEBUG else None,
        ...
        "endpoints": {
            ...
            "main": {
                "adventure_speech": "POST /api/adventure_speech",
                "draw_recognition": "POST /api/draw"
            },
            "admin": {
                "stats": "POST /api/admin/stats",
                "audit_log": "GET /api/admin/audit_log"
            },
            "billing": {
